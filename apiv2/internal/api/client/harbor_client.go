...
import (
	...
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/artifact"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/auditlog"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/gc"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/icon"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/ping"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/preheat"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/project"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/replication"
	...
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/scan"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/scan_all"
	"github.com/zelat/goharbor-client/v4/apiv2/internal/api/client/systeminfo"
)
