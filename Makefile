...
INTREGRATION_V1 = CGO_ENABLED=0 go test -p 1 -count 1 -v github.com/zelat/goharbor-client/v4/apiv1/... -tags integration
INTEGRATION_V2 = CGO_ENABLED=0 go test -p 1 -count 1 -v github.com/zelat/goharbor-client/v4/apiv2/... -tags integration
